...
{
    /// <inheritdoc />
    public partial class UpdateFromAndToPropertyToString : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SUBJECTS_FACULTY_HIERYICAL_FACULTY_Hieryrical_ID",
                        column: x => x.FACULTY_Hieryrical_ID,
                        principalTable: "FACULTY_HIERYICAL",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SUBJECTS_FACULTY_Hieryrical_ID",
                table: "SUBJECTS",
